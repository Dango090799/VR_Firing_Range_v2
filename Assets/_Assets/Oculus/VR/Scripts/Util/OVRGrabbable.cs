...
public class OVRGrabbable : MonoBehaviour
{
    ...
    {
        //get { return m_grabbedCollider.attachedRigidbody || gameObject.GetComponent<Collider>().attachedRigidbody; }
        get
        {
            ...
            {
                return gameObject.GetComponent<Collider>().attachedRigidbody;
            }
        }
    }

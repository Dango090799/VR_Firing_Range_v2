...
namespace OculusSampleFramework
{
    ...
    public class DistanceGrabber : OVRGrabber
    {
        ...
        protected override void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
        {
            ...
            //print(m_grabbedObj);
            //print(m_grabbedObj.GetComponent<Rigidbody>());
            ...
            //else
            //{
            //    if (m_grabbedObj.GetComponent<Rigidbody>())
            //    {
            //        m_grabbedObj.GetComponent<Rigidbody>().MovePosition(grabbablePosition);
            //        m_grabbedObj.GetComponent<Rigidbody>().MoveRotation(grabbableRotation);
            //    }
            //}
